...
let recipesData: [Recipe] = [
    Recipe(
        ...
        headLine: "Healthy Banana Ice Cream is so easy to make and tastes amazing.",
        image: "recipe_ice_cream",
        rating: 5,
        serves: 6,
        preparation: 5,
        cooking: 20,
    ...
    Recipe(
        title: "Banana Bread",
        headLine: "Moist and delicious banana bread recipe. Easy to make, no need for a mixer! Ripe bananas, butter, sugar, egg, vanilla, baking soda, and flour.",
        image: "recipe_bread",
        rating: 5,
        serves: 6,
        preparation: 10,
